		...
		<div class="container" style="width: 80%">
			...
			<form action="dispatch.php" method="post">
				...
				<div class="form-group row">
					<label for="callerName" class="col-lg-4 col-form-label">
						Caller's Name
					</label>
					<div class="col-lg-8">
				...
				<div class="form-group row">
					<label for="contactNo" class="col-lg-4 col-form-label">
				...
				<div class="form-group row">
					<label for="locationofIncident" class="col-lg-4 col-form-label">
				...
				<div class="form-group row">
					<label for="typeofIncident" class="col-lg-4 col-form-label">
				...
				<div class="form-group row">
					<label for="descriptionofIncident" class="col-lg-4 col-form-label">
